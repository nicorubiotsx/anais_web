      ...
      <nav className="text-white p-4 fixed top-0 left-0 w-full z-50 shadow-lg border-b-2 border-pink-400">
        <div className="container mx-auto flex justify-between items-center">
          ...
          <div className="block lg:hidden">
            <button onClick={toggleMenu} className=" text-pink-400 focus:outline-none">
          ...
          {/* Menu Items */}
          <div className={`lg:flex lg:items-center lg:space-x-6 absolute lg:relative top-full left-0 w-full lg:w-auto  lg:bg-transparent ${isOpen ? 'block' : 'hidden'} shadow-lg border-t-2 border-pink-400 lg:border-none`}>
