    ...
    return (
        <div className="mt-7 p-5 bg-dark from-pink-50 to-pink-100">
            ...
            <div className="">
                ...
                <div className="transform-animation border-4 border-pink-300 pl-6 flex flex-col  md:text-lg bg-dark rounded-lg shadow-lg p-5 slide-in   md:flex-row gap-6 mb-10 ">
                    ...
                    <div>
                        ...
                        <ul className="space-y-4 text-left text-white">
                            {["Tratamiento con exfoliación manual (bisturi)", "Remueve  piel  y celulas muerta", "Disminuye lineas de expresion", "isminuye manchas", "Estimula la sintesis de colageno", "Piel mas sana y luminosa"].map((item) => (
