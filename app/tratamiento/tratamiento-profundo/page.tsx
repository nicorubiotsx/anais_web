                ...
                <div className="border-4 border-pink-300 pl-6 flex flex-col  md:text-lg bg-dark rounded-lg shadow-lg p-5 slide-in   md:flex-row gap-6 mb-10 ">
                    ...
                    <div>
                        ...
                        <ul className="space-y-4 text-left text-white">
                            {["Emulsión desmaquillante", "Loción hidro-tónica", "Loción ablandante o macedonia", "Vapor de  ozono", "Peeling ultrasónico (Desincrustación de comedones)", "Dermoabrasión de alta frecuencia", "Sérum con principios activos", "Electroporación", "Masaje facial", "Crema sellante", "Protector solar 50"].map((item) => (
